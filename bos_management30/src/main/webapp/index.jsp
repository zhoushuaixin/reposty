...
//				},"json");
				...
				$.post("${pageContext.request.contextPath}/menu_showMenu.action",function(data){
					$.fn.zTree.init($("#treeMenu"), setting, data);
				},"json");
		...
		<div data-options="region:'center'">
			<div id="tabs" fit="true" class="easyui-tabs" border="false">
				<div title="消息中心" id="subWarp" style="width:100%;height:100%;overflow:hidden">
					<iframe src="${pageContext.request.contextPath}/home.jsp" style="width:100%;height:100%;border:0;"></iframe>
				</div>
			</div>
		</div>
