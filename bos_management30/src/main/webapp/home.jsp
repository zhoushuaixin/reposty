		...
		<script type="text/javascript">
			$(function() {
				panels = [ {
					...
					height : 255,
					collapsible : true,
					href:'${pageContext.request.contextPath}/pages/portal/gonggao.jsp'
				}, {
					id : 'p2',
					title : '代办事宜',
					height : 255,
					collapsible : true,
					href:'${pageContext.request.contextPath}/pages/portal/daiban.jsp'
				}, {
					id : 'p3',
					title : '预警信息',
					height : 255,
					collapsible : true,
					href:'${pageContext.request.contextPath}/pages/portal/yujing.jsp'
				}, {
					id : 'p4',
					title : '系统BUG反馈',
					height : 255,
					collapsible : true,
					href:'${pageContext.request.contextPath}/pages/portal/bug.jsp'
				}];
