				...
				<form id="dispatcherForm" method="post">
					<table class="table-edit" width="80%" align="center">
						...
						<tr>
							<td>选择快递员</td>
							<td>
								<input class="easyui-combobox" required="true" name="courier.id" data-options="valueField:'id',textField:'name',url:'${pageContext.request.contextPath}/courier_ajaxlist.action'" />
							</td>
						</tr>
					</table>
				</form>
